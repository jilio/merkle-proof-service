...
func (_KYCRecordRegistry *KYCRecordRegistryCaller) InitBlockHeight(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _KYCRecordRegistry.contract.Call(opts, &out, "initBlockHeight")
...
//
// Solidity: function initBlockHeight() view returns(uint256)
func (_KYCRecordRegistry *KYCRecordRegistrySession) InitBlockHeight() (*big.Int, error) {
	return _KYCRecordRegistry.Contract.InitBlockHeight(&_KYCRecordRegistry.CallOpts)
}

// InitBlockHeight is a free data retrieval call binding the contract method 0xef4b4119.
//
// Solidity: function initBlockHeight() view returns(uint256)
func (_KYCRecordRegistry *KYCRecordRegistryCallerSession) InitBlockHeight() (*big.Int, error) {
	return _KYCRecordRegistry.Contract.InitBlockHeight(&_KYCRecordRegistry.CallOpts)
}
